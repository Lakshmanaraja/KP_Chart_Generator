...
async def find_patterns_end_point(payload: FindPatternsRequest, bhava_number: str, cusp_bh_column: str = "house_id",planet_bh_column: str = "house"):
    ...
    result = find_patterns(client_ids=list_of_client_ids, bhava_number=bhava_number, cusp_bh_column=cusp_bh_column, planet_bh_column=planet_bh_column, cusp_cols=cusp_cols, planet_cols=planet_cols)
